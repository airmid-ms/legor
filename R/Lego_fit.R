...
#' @param year_range A numeric vector of length 2 specifying the year range the user wants to filter by, years must be written in ascending order. this parameter does not need to be specified if the user does not wish to filter by a specific range of years.
